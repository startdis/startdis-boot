...
import com.startdis.comm.kits.http.ServletUtils;
import com.startdis.comm.kits.ip.IpUtils;
...
public class FeignRequestInterceptor implements RequestInterceptor {
    ...
    public void apply(RequestTemplate requestTemplate) {
        ...
        if (StringKits.isNotNull(httpServletRequest)) {
            ...
            // 传递鉴权信息请求头，防止丢失
            requestTemplate.header(HeaderConstant.X_AUTH_TOKEN,headers.get(HeaderConstant.X_AUTH_TOKEN));
